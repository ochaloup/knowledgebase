...
** records: compiler will generate constructor, destructor, equals/hashCode/toString/accessors (no boilerplate for data carriers, as https://projectlombok.org[Lombok] does with `@Data`)
